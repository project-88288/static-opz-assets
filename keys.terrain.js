...
module.exports = {
  ...
  pisco: {
    mnemonic:
      "axis push scrub robust celery trash fashion cheap entire choose train crisp history space burst occur appear country tornado slush bone visa parade exile",
  },
  custom_tester_1: {
    mnemonic:
